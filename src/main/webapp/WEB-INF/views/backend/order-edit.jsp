            ...
            <div id="content">
                ...
                <div class="page-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- ============================================================== -->
                        <!-- basic table -->
                        <sf:form class="form" action="${classpath }/admin/order/edit-save" method="post" modelAttribute="saleOrder" enctype="multipart/form-data">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <sf:input path="code" type="text" class="form-control" id="code" name="code" placeholder="code" readonly="true"></sf:input>
                                                        </div>
                                                    </div>
                                                </div>
