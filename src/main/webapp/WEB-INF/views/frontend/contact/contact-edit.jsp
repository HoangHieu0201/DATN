                ...
                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="contact__form-input">
                                            <input type="text" class="form-input" placeholder="Your name..."
                                                id="txtName" name="txtName" value="${contact.name }">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="contact__form-input">
                                            <input type="email" class="form-input" placeholder="Email..."
                                                    id="txtEmail" name="txtEmail" value="${contact.email }">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="contact__form-input">
                                            <input type="text" class="form-input" placeholder="Your mobile..."
                                                id="txtMobile" name="txtMobile" value="${contact.mobile }">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="contact__form-input">
                                            <input type="text" class="form-input" placeholder="Your address..."
                                                id="txtAddress" name="txtAddress" value="${contact.address }">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="contact__form-input">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <ul class="contact__address">
                            ...
                            <li><i class='bx bx-envelope'></i> mailto:mail@gmail.com</li>
                        </ul>
                    </div>
                </div>
            </div>
