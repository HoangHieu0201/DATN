		...
		<div class="container-fluid"
			...
			<p class="mb-2 mt-1 pb-3">
				<a href="${classpath }/index">Trang chủ</a> > <a
					href="${classpath }/product">Cửa hàng</a> > <a href="">Sản phẩm</a>
			</p>
			<div class="row">
				<!-- ảnh sp -->
				<div class="col-lg-5">
								...
								<c:forEach items="${productImages }" var="productImage">
									<div class="col-lg-3 mt-3 small_img">
										<img src="${classpath }/FileUploads/${productImage.path }"
											class="img-fluid" style="height: 110%;"
					...
					<div class="detail">
						<h4 class="detail__heading mt-4">Chi tiết sản phẩm</h4>
						<div class="detail__text" id="productDescription">
							<p>${product.detailDescription }</p>
						</div>
						<button id="toggleButton" onclick="toggleDescription()">Xem
							thêm</button>
					</div>
				</div>
				<!-- cột thông tin -->
				<div class="col-lg-7">
					...
					<div class="row">
						<div class="card" style="border: 0;">
							<div class="card-body pt-0">
								...
								<div class="freeship">🚍Free ship toàn quốc</div>
							</div>
						</div>
					</div>
					...
					<div class="row pl-3">
						<div class="price" style="width: 100%;">
							<h5
								style="text-decoration: line-through; color: rgb(53, 52, 52);">
					...
					<div class="row pl-3 mt-2 mb-3">
						...
						<button type="button"
							...
							class="btn btn-warning ml-4">Thêm vào giỏ hàng</button>
					</div>
					...
					<div class="row pl-3">
						...
						<fieldset>
							<legend class="legend">
								<center>🎁 Mua hàng online</center>
							</legend>
							<label>1. Tặng tai nghe không dây trị giá 300k</label> <br>
							<label>2. Bộ sạc nhanh trị giá 300k</label> <br> <label>3.
								Bộ sạc không dây trị giá 300k</label> <br> <label>4. Ốp
								lưng solicol trị giá 300k</label> <br> <label>5. Phiếu giảm
								giá 300k cho mọi sản phẩm</label>
						</fieldset>
					</div>
